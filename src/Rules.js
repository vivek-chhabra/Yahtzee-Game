...
class SmallStraight extends Rule {
    evalRoll = (dice) => {
        ...
        let isSmallSt = dice.includes(5) || (dice.includes(1) && dice.includes(2) && dice.includes(3) && dice.includes(4)) || dice.includes(6) || (dice.includes(2) && dice.includes(3) && dice.includes(4) && dice.includes(5));
        return isSmallSt ? this.score : 0;
    };
}
